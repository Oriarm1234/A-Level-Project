...
class Overlay:
    ...
    @property
    def Elements(self): return self._elements["allElements"]

    @property
    def InteractiveElements(self): return self._elements["interactive"]
    ...
    def draw(self, screen=None):
        if screen != None:
            screen.blit(self._screen, (self._pos[0] + self.get_offset_x(), self._pos[1] + self.get_offset_y()))
